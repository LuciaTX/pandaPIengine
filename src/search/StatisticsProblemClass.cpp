...
<<<<<<< HEAD
        ...
        if (n->numAbstract == 1) {
=======
        if (sizeof(n->unconstraintAbstract) > 1 || sizeof(n->unconstraintPrimitive) > 1 || \
             (sizeof(n->unconstraintAbstract) == 0 && sizeof(n->unconstraintPrimitive) == 0 && n->containedTaskCount != 0)) {
            isNodeTO[n] = false;
            return false;
        }
        if (sizeof(n->unconstraintAbstract) == 1) {
>>>>>>> 58a60b2b885244e247519a4bdaa5c5488d20b612
...
=======
        else if (sizeof(n->unconstraintPrimitive) == 1) {
>>>>>>> 58a60b2b885244e247519a4bdaa5c5488d20b612
...
=======
                // if father node is acyclic, then n is regular
>>>>>>> 58a60b2b885244e247519a4bdaa5c5488d20b612
...
=======
            if (sizeof(htn->sccToTasks[scc]) != 1) {
>>>>>>> 58a60b2b885244e247519a4bdaa5c5488d20b612
                isNodeAcyclic[n] = false;
                return false;
            }
